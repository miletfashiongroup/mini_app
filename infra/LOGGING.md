...
- Sentry (self-hosted) captures application errors; DSN placeholders wired in backend/frontend env vars. UI доступен на `http://<host>:9000` (без nginx proxy), health: `/_health/`.

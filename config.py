...
class Settings(BaseSettings):
    ...
    analytics_report_dashboard_daily_url: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "BRACE_ANALYTICS_DASHBOARD_DAILY_URL",
            "ANALYTICS_DASHBOARD_DAILY_URL",
        ),
        description="Public dashboard URL for daily analytics report.",
    )
    analytics_report_dashboard_weekly_url: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "BRACE_ANALYTICS_DASHBOARD_WEEKLY_URL",
            "ANALYTICS_DASHBOARD_WEEKLY_URL",
        ),
        description="Public dashboard URL for weekly analytics report.",
    )
    analytics_report_dashboard_monthly_url: str | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "BRACE_ANALYTICS_DASHBOARD_MONTHLY_URL",
            "ANALYTICS_DASHBOARD_MONTHLY_URL",
        ),
        description="Public dashboard URL for monthly analytics report.",
    )
